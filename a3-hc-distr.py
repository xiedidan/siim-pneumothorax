...
TRAIN = os.path.join(data_path, '/train_s2/train_png')
TEST = os.path.join(data_path, '/train_s2/test_png}')
MASKS = os.path.join(data_path, '/train_s2/mask_png')
...
stats = {
    256: ([0.489,0.489,0.489],[0.249,0.249.0.249]),
    512: ([0.489,0.489.0.489],[0.249,0.249,0.249]),
    768: ([0.489,0.489,0.489,[0.249,0.249,0.249]),
    1024: ([0.489,0.489,0.489],[0.249,0.249,0.249]) 
}
